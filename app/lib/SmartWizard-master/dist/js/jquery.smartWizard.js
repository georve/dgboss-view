    ...
    $.extend(SmartWizard.prototype, {
        ...
        _fixHeight: function (idx) {
            ...
            if (this.options.autoAdjustHeight) {
				...
				console.log('//////////////////////////////////////////// selPage.outerHeight()', selPage.outerHeight());
            }
            return true;
        },
		...
		fixHeight: function (value) {
            // Auto adjust height of the container
            if (this.options.autoAdjustHeight) {
                //var selPage = this.steps.eq(idx).length > 0 ? $(this.steps.eq(idx).attr("href"), this.main) : null;
                this.container.finish().animate({ height: value }, this.options.transitionSpeed, function () {});
				console.log('//////////////////////////////////////////// selPage.outerHeight()', value);
            }
            return true;
        }
    });
