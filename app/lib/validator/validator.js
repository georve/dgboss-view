...
var validator = (function($){
    ...
    */
    message = {
        ...
        checked         : 'Esta opción debe ser marcada.',
        empty           : 'Introduzca datos aquí.',
        min             : 'Datos muy cortos.',
        max             : 'Datos muy largos.',
        number_min      : 'Valor muy bajo.',
        ...
        repeat          : 'No coinciden.',
        complete        : 'El dato no está completo.',
    ...
    */
    tests = {
        ...
        email : function(a){
            console.log(a);
            console.log(email_filter.test(a));
        ...
        text : function(a, skip){
            ...
            if( lengthRange && a.length < lengthRange[0] ){
                console.log('validator minlenght');
